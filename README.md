...
以提高 OpenClash、Mihomo、Stash 和塔台之间的兼容性。
...
请在实际使用时替换为自己的 Clash / Mihomo 机场订阅地址。
...
以后升级 V4、V5 时，只更新 Clash.yaml 内容，不需要修改客户端订阅地址。
